class CodebaseMemoryMcp < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/tigercosmos/cpp-codebase-memory-mcp/releases/download/v#{version}/codebase-memory-mcp-darwin-arm64.tar.gz"
      sha256 "3468e5df340e53dba2d23cc30bf44210c412dfb2538d7da992465934bf4980e0"
    end
    on_intel do
      url "https://github.com/tigercosmos/cpp-codebase-memory-mcp/releases/download/v#{version}/codebase-memory-mcp-darwin-amd64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/tigercosmos/cpp-codebase-memory-mcp/releases/download/v#{version}/codebase-memory-mcp-linux-arm64.tar.gz"
      sha256 "29811aadc2aa99fb9612683af30a06d03fcb2bfefb95c12ea672671827bd111c"
    end
    on_intel do
      url "https://github.com/tigercosmos/cpp-codebase-memory-mcp/releases/download/v#{version}/codebase-memory-mcp-linux-amd64.tar.gz"
  ...
  def caveats
    <<~EOS
      ...
      To tap this formula directly:
        brew tap deusdata/codebase-memory-mcp https://github.com/tigercosmos/cpp-codebase-memory-mcp
